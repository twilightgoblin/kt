...
const Hero = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/kalyanitewari/',
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
    ...
    <div id="home" style={{ width: '100%', height: '100vh', position: 'relative' }}>
      ...
      <div className="hero-content">
        ...
        <div className="hero-text">
          ...
          />
          <FallingText
            text={`AI & ML engineering student with hands-on experience at Microsoft and DRDO, strong applied ML projects, and notable leadership and achievements.`}
            highlightWords={["AI", "&", "engineering", "Microsoft", "DRDO", "ML"]}
            highlightClass="highlighted"
            trigger="hover"
            backgroundColor="transparent"
            wireframes={false}
